 ...
 * @since 1.5
 */
class CommentControllerInstaller extends CommentController {
	...
	public function install() {
		...
		if($model->install()) {
			$message = JText::_('The plugin was successfully installed');
			$appl->redirect('index.php?option=com_comment&view=installer', $message);
		}
