...
class JOSC_com_REPLACEnewplugin extends JOSC_component {
	...
	private $id;
	private $component;
	private $componentTable = '#__ReplaceTable';
	private $componentTableFieldId = 'replaceField';
	private $componentTableFieldTitle = 'replaceField';
	private $componentTableFieldDescription = 'replaceField';
	private $componentCategoryTable = '#__ReplaceTable';
	private $componentSectionTable = '#__ReplaceTable';
	private $feedName = 'replaceFeedName';
	private $singleView = 'replaceSingleView';

	public function __construct($component, &$row, &$list) {
		$this->id = isset($row->REPLACEid) ? $row->REPLACEid : 0; /* document id */
	...
	function linkToContent($contentId, $commentId='') {
		...
		$link = JRoute::_('write specific url for the plugin' . $contentId) . $comment;
